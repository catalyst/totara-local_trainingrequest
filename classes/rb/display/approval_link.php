...
class approval_link extends \totara_reportbuilder\rb\display\base {
    ...
    public static function display($value, $format, \stdClass $row, \rb_column $column, \reportbuilder $report) {
        ...
        $request = $DB->get_record_sql('SELECT enddate, status, directmanagerid FROM {trainingrequests} WHERE id = :id', array('id' => $value));
        if (
